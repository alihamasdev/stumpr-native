...
export const AnimatedPressable = forwardRef<View, AnimatedPressableProps>(
	({ pressScale = 0.97, pressOpacity = 1, onPressIn, onPressOut, style, ...props }, ref) => {
		...
		return <AnimatedPressableBase ref={ref} style={[animatedStyle, style as never]} onPressIn={handlePressIn} onPressOut={handlePressOut} {...props} />;
	},
);
